...
test('knowledge base file table scrolls inside its card', () => {
  ...
  assert.match(documentsViewSource, /\.documents-memory-card\s*\{[^}]*flex:\s*0 0 clamp\(230px,\s*25vh,\s*280px\)/s)
  assert.match(documentsViewSource, /\.documents-memory-card\s*\{[^}]*min-height:\s*230px/s)
  assert.doesNotMatch(documentsViewSource, /\.documents-memory-card\s*\{[^}]*flex:\s*0 0 clamp\(220px,\s*25vh,\s*280px\)/s)
  assert.match(documentsViewSource, /\.documents-memory-card\s*\{[^}]*max-height:\s*280px/s)
  assert.doesNotMatch(documentsViewSource, /\.documents-memory-card\s*\{[^}]*max-height:\s*340px/s)
